\begin{figure*}[t]
	...
	\begin{subfigure}[b]{0.32\textwidth}
		...
		\begin{tikzpicture}[scale=1.25, >=stealth]
			...
			\end{scope}
			\draw[thick, rounded corners=6pt] (-1.7,-1.1) rectangle (1.7,1.1);
			% the edge of the unsafe region, in gray
			\draw[gray!60, thin] plot[variable=\t, domain=0:1.1, samples=30] ({1.7-2.2*(1.1-\t)*(1.1-\t)},{1.1-\t});
			\draw[gray!60, thin] plot[variable=\t, domain=0:1.1, samples=30] ({-1.7+2.2*(1.1-\t)*(1.1-\t)},{-1.1+\t});
